module Georgia
  class PagesController < ApplicationController
    ...
    def publish
      ...
      if @page.save
        # Notifier.notify_admins(@page, "#{current_user.name} has published the job '#{@page.title}'").deliver
    ...
    def unpublish
      ...
      @page.unpublish
      if @page.save
        # Notifier.notify_admins(@page, "#{current_user.name} has unpublished the job '#{@page.title}'").deliver
