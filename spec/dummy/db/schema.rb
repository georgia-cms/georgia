...
ActiveRecord::Schema.define(version: 20141212193407) do
  ...
  create_table "georgia_revisions", force: true do |t|
    ...
    t.integer  "revised_by_id"
  end

  add_index "georgia_revisions", ["revised_by_id"], name: "index_georgia_revisions_on_revised_by_id"
